...
public class Beta166TexturePackBuilder extends Beta173TexturePackBuilder {
    public Beta166TexturePackBuilder(ResourcePackStack resourcePack) {
        super(resourcePack);
    }
    ...
    protected BufferedImage moveBlockUp(BufferedImage block, int amount) {
        int scale = block.getWidth() / 16;
        ...
        g2.drawImage(block, 0, -amount * scale, null);
        return newBlock;
    }
