...
public class Beta1501TexturePackBuilder extends Beta166TexturePackBuilder {
    public Beta1501TexturePackBuilder(ResourcePackStack resourcePack) {
        super(resourcePack);
    }
    ...
    protected BufferedImage addGreyBackgroud(BufferedImage block) {
        BufferedImage newBlock = new BufferedImage(block.getWidth(), block.getHeight(), BufferedImage.TYPE_INT_ARGB);
        Graphics2D g2 = newBlock.createGraphics();
        g2.setColor(Color.GRAY);
        g2.fillRect(0, 0, block.getWidth(), block.getHeight());
        g2.drawImage(block, 0, 0, null);
        return newBlock;
    }
